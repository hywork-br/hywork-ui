...
export default defineConfig({
  ...
  projects: [
    { name: "chromium", testMatch: ["**/interactions.spec.ts", "**/quiet-fields.spec.ts"], use: { browserName: "chromium" } },
    { name: "firefox", testMatch: ["**/interactions.spec.ts", "**/quiet-fields.spec.ts"], use: { browserName: "firefox" } },
