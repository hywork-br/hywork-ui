...
export default defineConfig({
  ...
  projects: [
    { name: "chromium", testMatch: ["**/interactions.spec.ts", "**/navigation.spec.ts", "**/quiet-fields.spec.ts", "**/scoped-theme.spec.ts", "**/theme-lab.spec.ts", "**/stepper.spec.ts", "**/tree-view.spec.ts"], use: { browserName: "chromium" } },
    { name: "firefox", testMatch: ["**/interactions.spec.ts", "**/navigation.spec.ts", "**/quiet-fields.spec.ts", "**/scoped-theme.spec.ts", "**/theme-lab.spec.ts", "**/stepper.spec.ts", "**/tree-view.spec.ts"], use: { browserName: "firefox" } },
