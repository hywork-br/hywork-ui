...
>(({ className, contentClassName, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      {/* O respiro entre cabeçalho, corpo e rodapé mora aqui: o gap do Content não chega nos filhos. */}
      <div className={cn("flex flex-1 min-w-0 min-h-0 flex-col gap-6 break-words overflow-wrap-anywhere", contentClassName)}>
        {children}
      </div>
      <DialogPrimitive.Close className="absolute right-3 top-3 grid h-10 w-10 place-items-center rounded-md text-muted-foreground ring-offset-background transition-colors motion-reduce:!transition-none hover:bg-muted hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none">
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  // Decisão da PO (23/09): botões no tamanho padrão, à direita, 8px entre eles; nunca largura total.
