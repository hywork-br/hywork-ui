  ...
  theme: {
    extend: {
      colors: {
        ...
        "interactive-hover": "var(--hw-interactive-hover)",
        "interactive-hover-fg": "var(--hw-interactive-hover-fg)",
        "floating": "var(--hw-floating)",
        ...
        "nav-active": "var(--hw-nav-active)",
        "nav-active-fg": "var(--hw-nav-active-fg)",
        "nav-active-rail": "var(--hw-nav-active-rail)",
        "focus": "var(--hw-focus)",
